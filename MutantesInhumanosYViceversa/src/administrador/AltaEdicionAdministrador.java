...
public class AltaEdicionAdministrador extends javax.swing.JPanel {
    ...
    private void rellenarCombos() {
        ...
        switch (mServCargaVentana.getCodError()) {
            case Constantes.OK:
                ...
                for (Rol rol : mServCargaVentana.getListaRol()) {
            ...
            case Constantes.ERROR_BD:
                ...
                JOptionPane.showMessageDialog(this, mServCargaVentana.getMensaje(), "Administrador", JOptionPane.ERROR_MESSAGE);
                break;
        }
    }
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        //Editamos al usuario
        if (ventanaEdicion) {
            mUsuario.setAccion(Constantes.ACCION_ACTUALIZAR_USUARIO);
        } else {
            mUsuario.setAccion(Constantes.ACCION_CREAR_USUARIO);
        }
        ...
        switch (mUsuario.getCodError()) {
            case Constantes.OK:
                JOptionPane.showMessageDialog(this, mUsuario.getMensaje(), "Adminstrador", JOptionPane.INFORMATION_MESSAGE);
                //Ocultamos el panel
                this.setVisible(false);
            ...
            case Constantes.ERROR_BD:
                //Mostramos el mensaje devuelto por el servidor
                JOptionPane.showMessageDialog(this, mUsuario.getMensaje(), "Adminstrador", JOptionPane.ERROR_MESSAGE);
                break;
        }
